...
#define VERSION "Version ArDAS 0.9c [UMONS-GFA - 2015]"
#define EOL '\r'
    ...
    if (c == EOL){
        ...
        if( first_character == '-') {
            ...
            if (recv_netid == (uint16_t) netid) {
              ...
              delay(25*netid); // to avoid that everyone responds at the same time
              toggle_rts();
              Serial.print(F("\n\r\n\rHey! I'm ArdDAS "));
              SerialPrintf("%03d", netid);
              Serial.print(F("\n\r"));
